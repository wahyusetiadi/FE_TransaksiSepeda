    ...
    <div className="w-[560px] p-8 h-auto rounded-lg bg-white z-50 max-md:w-[300px] max-md:p-6">
      <div className="w-full flex">
        <div className="w-full flex items-center justify-start">
          <h1 className="text-2xl max-md:text-lg font-bold">Detail Barang</h1>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex items-center my-4">
              ...
              <div className="w-full justify-end flex gap-5">
                <input
                  className="w-10 h-10 max-md:w-8 max-md:h-8 p-2 border-2 rounded-lg text-center text-lg max-md:text-xs font-bold text-gray-900"
